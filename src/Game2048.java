...
public class Game2048 extends JPanel {
	...
	private static final Color BG_COLOR = new Color(174,234,230);
	...
	public static void HighScoreFiling () throws FileNotFoundException, IOException {
	...
	private void drawTile(Graphics g2, Tile tile, int x, int y) {
		...
		if (myWin || myLose) {
			if (myWin) {
				UIManager.put("OptionPane.background", new Color(60, 187, 177));
				UIManager.put("Panel.background", Color.decode("#AEEAE6"));
				ImageIcon icon = new ImageIcon("iconGame.png");
				UIManager.put("OptionPane.minimumSize", new Dimension(340, 160));
				UIManager.put("OptionPane.messageFont", font.deriveFont(Font.TRUETYPE_FONT, 14));
				int option;
			...
			if (myLose) {
				...
				UIManager.put("OptionPane.messageFont", font.deriveFont(Font.TRUETYPE_FONT, 14));
				int option;
				option = JOptionPane.showConfirmDialog(null, "You lose" + "\n Your score : " + myScore + "\n The Highest score : " 
						+ highScore +  "\n Play again?", "Game over",
						JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE,
						icon);	 	  
				if (option == 1 ) {
		...
		try {
			HighScoreFiling();
			g.drawString("High Score: " + highScore, 50, 365);
	...
	static class Tile {
		...
		public Color getBackground() {
			switch (value) {
			case 2:    return new Color(171,198,208);
			case 4:    return new Color(138,208,250);
			case 8:    return new Color(85,204,212);
			case 16:   return new Color(239,188,155);
			case 32:   return new Color(22,186,197);
			case 64:   return new Color(226,179,166);
			case 128:  return new Color(211,141,122);
			case 256:  return new Color(183,65,34);
			case 512:  return new Color(245,170,146);
			case 1024: return new Color(240,119,81);
			case 2048: return new Color(235,69,17);
			}
